define("fare/oc/1.0.0/abrqueryMain-debug", [ "./abrquery-debug", "jquery-debug", "tuiValidator-debug", "datepicker-debug", "tuiDialog-debug", "./common-debug", "./abrdelete-debug" ], function(require) {
    var abrQuery = require("./abrquery-debug");
    new abrQuery();
    var abrDelete = require("./abrdelete-debug");
    var abrdelete = new abrDelete();
    abrdelete.init();
});

define("fare/oc/1.0.0/abrquery-debug", [ "jquery-debug", "tuiValidator-debug", "datepicker-debug", "tuiDialog-debug", "fare/oc/1.0.0/common-debug" ], function(require, exports, module) {
    ...
    abrQuery.prototype.getData = function() {
        var paramTemp = {};
        paramTemp["serviceType"] = this.getServiceTypeData("serviceType");
        //发布状态
        paramTemp["carrier"] = $("#carrier").val();
        //航空公司
        paramTemp["subCode"] = $("#subCode").val();
        //子代码
        paramTemp["effectMaxDate"] = $("#effectMaxDate").val();
        //生效日期上限
        paramTemp["effectMinDate"] = $("#effectMinDate").val();
        //生效日期下限
        paramTemp["dataSource"] = $("#dataSource").val();
        //数据源
        paramTemp["internationalTag"] = $("#internationalTag").val();
        //行程种类
        paramTemp["departmentCode"] = $("#departmentCode").val();
        //部门代码
        return paramTemp;
    };
...
define("fare/oc/1.0.0/abrdelete-debug", [ "jquery-debug", "fare/oc/1.0.0/common-debug" ], function(require, exports, module) {
    // 通过require引入依赖
    var $ = require("jquery-debug");
    var Common = require("fare/oc/1.0.0/common-debug");
    var common = new Common();
