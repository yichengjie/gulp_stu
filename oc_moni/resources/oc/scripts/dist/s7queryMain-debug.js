define("fare/oc/1.0.0/s7queryMain-debug", [ "./s7query-debug", "jquery-debug", "tuiValidator-debug", "datepicker-debug", "tuiDialog-debug", "./common-debug", "./equipment-debug", "./util-debug", "underscore-debug", "./s7publish-debug", "./s7delete-debug" ], function(require) {
...
define("fare/oc/1.0.0/s7query-debug", [ "jquery-debug", "tuiValidator-debug", "datepicker-debug", "tuiDialog-debug", "fare/oc/1.0.0/common-debug", "fare/oc/1.0.0/equipment-debug", "fare/oc/1.0.0/util-debug", "underscore-debug" ], function(require, exports, module) {
    //通过require引入依赖
    ...
    var util = require("fare/oc/1.0.0/util-debug");
...
define("fare/oc/1.0.0/util-debug", [], function(require, exports, module) {
    var util = {};
